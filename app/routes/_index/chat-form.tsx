...
import { AutoResizeTextarea } from '~/routes/_index/autoresize-textarea';
  ...
  return (
    ...
    >
      ...
      <form
        ...
        className="border-input bg-background focus-within:ring-ring/10 relative mx-6 mb-6 flex items-center rounded-[16px] border px-3 py-1.5 pr-8 text-sm focus-within:ring-2 focus-within:ring-offset-0 focus-within:outline-none"
      >
        <AutoResizeTextarea
